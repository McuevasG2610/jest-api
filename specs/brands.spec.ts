import controler from '../controller/brand.controller'
...
describe('Brands', () => {
    ...
    describe('Fetch brands', () => {
        it('GET /brands', async () => {
            const res = await controler.getBrands();
    ...
    describe('Create brands', () => {
        ...
        beforeAll(async () => {
            postBrand = await controler.postBrands(data);
        })

        afterAll(async () =>{
             await controler.deleteBrands(postBrand.body._id)
        })
        ...
        it('Schema Verification - Name is a mandatory field', async () => {
            ...
            const res = await controler.postBrands(data);
        ...
        it('Business Logic - Duplicate brand entries not allowed', async () => {
            // second request
            const res2 = await controler.postBrands(data);
    ...
    describe('Fetch Individual Brand', () => {
        ...
        afterAll(async () =>{
            ...
            it('Business Logic - GET /brand/invalid_id should throw 404', async () => {
                ...
                const res = await controler.getBrandById('12348f0500b2931578c0a5ac')
            ...
            it('GET /brand/:id', async () => {
                //const res = await request.get('/brands/' + postBrand.body._id);
                 const res = await controler.getBrandById(postBrand.body._id)
                expect(res.statusCode).toEqual(200);
    ...
    describe('Update brands', () => {
        ...
        it('PUT /brands', async () => {
            ...
            const res = await controler.putBrands(postBrand.body._id,data)
        ...
        it('PUT /brands/invalid_id', async () => {
            ...
            const res = await controler.putBrands('123',data)
    ...
    describe('Delete Brands', () => {
        ...
        it('DELETE /brands', async () => {
            const res = await controler.deleteBrands(postBrand.body._id)
            expect(res.statusCode).toEqual(200)
        });
        it('DELETE /brands/invalid_id', async () => {
            const res = await  controler.deleteBrands('123');
            expect(res.statusCode).toEqual(422)
